...
# https://finnhub.io/
finnhub_client = finnhub.Client(api_key="c3rjodiad3i88nmltfn0")
finnhub_client2 = finnhub.Client(api_key="c3rjodiad3i88nmltfn0")
...
# def check_role_admin_or_user(user):	
#     db.execute(f"SELECT * FROM DiscordUserVerify")
#     user = db.fetchall()
# 
#     userID = DiscordUser.id
#     
#     if DiscordUser.is_authenticated:
#         print("User False")
#         return False
#     else:
#         print("USER True")
