function display_data() {
    ...
    input_rank.innerHTML = "<input class='inptSrch' placeholder=' ' onkeyup='searchColumn(this, 0)'>"
    input_day.innerHTML = "<input class='inptSrch' placeholder=' ' onkeyup='searchColumn(this, 1)'>"
    input_date.innerHTML = "<input class='inptSrch' placeholder=' ' onkeyup='searchColumn(this, 2)'>"
    input_open.innerHTML = "<input class='inptSrch' placeholder=' ' onkeyup='searchColumn(this, 3)'>"
    input_high.innerHTML = "<input class='inptSrch' placeholder=' ' onkeyup='searchColumn(this, 4)'>"
    input_low.innerHTML = "<input class='inptSrch' placeholder=' ' onkeyup='searchColumn(this, 5)'>"
    input_close.innerHTML = "<input class='inptSrch' placeholder=' ' onkeyup='searchColumn(this, 6)'>"
    input_vol.innerHTML = "<input class='inptSrch' placeholder=' ' onkeyup='searchColumn(this, 7)'>"
    input_price_change.innerHTML = "<input class='inptSrch' placeholder=' ' onkeyup='searchColumn(this, 8)'>"
    input_amplitude.innerHTML = "<input class='inptSrch' placeholder=' ' onkeyup='searchColumn(this, 9)'>"
    input_vol_change.innerHTML = "<input class='inptSrch' placeholder=' ' onkeyup='searchColumn(this, 10)'>"
    input_vol_price_ratio.innerHTML = "<input class='inptSrch' placeholder=' ' onkeyup='searchColumn(this, 11)'>"
    ...
    for (i=2; i<historical_data.length; i++) {
        ...
        if (td[2].innerHTML == latest_date) {
            historical_data[i].style.fontWeight = "regular";
            historical_data[i].style.backgroundColor = "transparent";
        }
        ...
        if (String(td[8].innerHTML).includes("-")) {
            td[8].style.color = "#d9534f";
        }
        else {
            td[8].style.color = "#77c13a";
        }

        if (String(td[10].innerHTML).includes("-")) {
            td[10].style.color = "#d9534f";
        }
        else {
            td[10].style.color = "#77c13a";
        }
